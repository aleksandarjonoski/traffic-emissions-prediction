...
trafic_image = Image.open('/home/stefan/personal/traffic-emissions-prediction/vehicle-detection-classifier/traffic.png')
...
for i in range(len(my_dict_key)):
    ...
    crop_car.save(f'/home/stefan/personal/traffic-emissions-prediction/vehicle-detection-classifier/images/{my_dict_key[i]}.jpeg')# where to save the images
